# Comparing `tmp/kicks-0.45.0.tar.gz` & `tmp/kicks-0.46.0.tar.gz`
...
## Comparing `kicks-0.45.0.tar` & `kicks-0.46.0.tar`
...
### Comparing `kicks-0.45.0/PKG-INFO` & `kicks-0.46.0/PKG-INFO`
...
### Comparing `kicks-0.45.0/pyproject.toml` & `kicks-0.46.0/pyproject.toml`
...
### Comparing `kicks-0.45.0/src/kicks/__main__.py` & `kicks-0.46.0/src/kicks/__main__.py`
...
### Comparing `kicks-0.45.0/src/kicks.egg-info/PKG-INFO` & `kicks-0.46.0/src/kicks.egg-info/PKG-INFO`
