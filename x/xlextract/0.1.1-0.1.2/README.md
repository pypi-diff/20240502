# Comparing `tmp/xlextract-0.1.1.tar.gz` & `tmp/xlextract-0.1.2.tar.gz`
...
### Comparing `xlextract-0.1.1/xlextract/.mypy_cache/3.11/_ast.data.json` & `xlextract-0.1.2/xlextract/.mypy_cache/3.11/_ast.data.json`
