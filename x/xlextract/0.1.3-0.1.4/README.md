# Comparing `tmp/xlextract-0.1.3.tar.gz` & `tmp/xlextract-0.1.4.tar.gz`
...
### Comparing `xlextract-0.1.3/xlextract/.mypy_cache/3.11/_ast.data.json` & `xlextract-0.1.4/xlextract/.mypy_cache/3.11/_ast.data.json`
