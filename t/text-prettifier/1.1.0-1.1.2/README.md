# Comparing `tmp/text_prettifier-1.1.0.tar.gz` & `tmp/text_prettifier-1.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "text_prettifier-1.1.0.tar", last modified: Tue Apr 30 11:02:24 2024, max compression
+gzip compressed data, was "text_prettifier-1.1.2.tar", last modified: Thu May  2 16:24:42 2024, max compression
```

## Comparing `text_prettifier-1.1.0.tar` & `text_prettifier-1.1.2.tar`

### file list

```diff
@@ -1,15 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-30 11:02:24.255544 text_prettifier-1.1.0/
--rw-r--r--   0 runner    (1001) docker     (127)     1069 2024-04-30 11:02:19.000000 text_prettifier-1.1.0/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     5349 2024-04-30 11:02:24.255544 text_prettifier-1.1.0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     4348 2024-04-30 11:02:19.000000 text_prettifier-1.1.0/README.md
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-30 11:02:24.255544 text_prettifier-1.1.0/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1470 2024-04-30 11:02:19.000000 text_prettifier-1.1.0/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-30 11:02:24.255544 text_prettifier-1.1.0/text_prettifier/
--rw-r--r--   0 runner    (1001) docker     (127)       44 2024-04-30 11:02:19.000000 text_prettifier-1.1.0/text_prettifier/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     7705 2024-04-30 11:02:19.000000 text_prettifier-1.1.0/text_prettifier/text_prettifier.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-30 11:02:24.255544 text_prettifier-1.1.0/text_prettifier.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     5349 2024-04-30 11:02:24.000000 text_prettifier-1.1.0/text_prettifier.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      283 2024-04-30 11:02:24.000000 text_prettifier-1.1.0/text_prettifier.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-30 11:02:24.000000 text_prettifier-1.1.0/text_prettifier.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       41 2024-04-30 11:02:24.000000 text_prettifier-1.1.0/text_prettifier.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-04-30 11:02:24.000000 text_prettifier-1.1.0/text_prettifier.egg-info/top_level.txt
...
### Comparing `text_prettifier-1.1.0/LICENSE` & `text_prettifier-1.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `text_prettifier-1.1.0/PKG-INFO` & `text_prettifier-1.1.2/PKG-INFO`
...
### Comparing `text_prettifier-1.1.0/README.md` & `text_prettifier-1.1.2/README.md`

 * *Files identical despite different names*

### Comparing `text_prettifier-1.1.0/setup.py` & `text_prettifier-1.1.2/setup.py`
...
### Comparing `text_prettifier-1.1.0/text_prettifier/text_prettifier.py` & `text_prettifier-1.1.2/text_prettifier/text_prettifier.py`

 * *Files identical despite different names*

### Comparing `text_prettifier-1.1.0/text_prettifier.egg-info/PKG-INFO` & `text_prettifier-1.1.2/text_prettifier.egg-info/PKG-INFO`
