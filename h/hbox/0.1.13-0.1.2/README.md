# Comparing `tmp/hbox-0.1.13.tar.gz` & `tmp/hbox-0.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hbox-0.1.13.tar", max compression
+gzip compressed data, was "hbox-0.1.2.tar", max compression
```

## Comparing `hbox-0.1.13.tar` & `hbox-0.1.2.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0     1078 2024-05-02 05:15:54.015576 hbox-0.1.13/LICENSE
--rw-r--r--   0        0        0     6331 2024-05-02 05:15:54.015576 hbox-0.1.13/README.md
--rw-r--r--   0        0        0     6635 2024-05-02 05:15:54.015576 hbox-0.1.13/hbox/commands.py
--rw-r--r--   0        0        0     2212 2024-05-02 05:15:54.015576 hbox-0.1.13/hbox/config.py
--rw-r--r--   0        0        0      684 2024-05-02 05:15:54.015576 hbox-0.1.13/hbox/logger.py
--rw-r--r--   0        0        0     3094 2024-05-02 05:15:54.015576 hbox-0.1.13/hbox/main.py
--rw-r--r--   0        0        0     2292 2024-05-02 05:15:54.015576 hbox-0.1.13/hbox/utils.py
--rw-r--r--   0        0        0      428 2024-05-02 05:15:54.015576 hbox-0.1.13/pyproject.toml
--rw-r--r--   0        0        0     6802 1970-01-01 00:00:00.000000 hbox-0.1.13/PKG-INFO
...
### Comparing `hbox-0.1.13/README.md` & `hbox-0.1.2/PKG-INFO`
...
### Comparing `hbox-0.1.13/hbox/commands.py` & `hbox-0.1.2/hbox/commands.py`
...
### Comparing `hbox-0.1.13/hbox/config.py` & `hbox-0.1.2/hbox/config.py`
