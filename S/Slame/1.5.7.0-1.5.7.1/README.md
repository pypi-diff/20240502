# Comparing `tmp/Slame-1.5.7.0.tar.gz` & `tmp/Slame-1.5.7.1.tar.gz`
...
## Comparing `Slame-1.5.7.0.tar` & `Slame-1.5.7.1.tar`
...
### Comparing `Slame-1.5.7.0/PKG-INFO` & `Slame-1.5.7.1/PKG-INFO`
...
### Comparing `Slame-1.5.7.0/README.md` & `Slame-1.5.7.1/README.md`

 * *Files identical despite different names*

### Comparing `Slame-1.5.7.0/Slame/slame.py` & `Slame-1.5.7.1/Slame/slame.py`
...
### Comparing `Slame-1.5.7.0/Slame.egg-info/PKG-INFO` & `Slame-1.5.7.1/Slame.egg-info/PKG-INFO`
...
### Comparing `Slame-1.5.7.0/setup.py` & `Slame-1.5.7.1/setup.py`
