# Comparing `tmp/Slame-1.5.7.2.tar.gz` & `tmp/Slame-1.5.7.3.tar.gz`
...
## Comparing `Slame-1.5.7.2.tar` & `Slame-1.5.7.3.tar`
...
### Comparing `Slame-1.5.7.2/PKG-INFO` & `Slame-1.5.7.3/PKG-INFO`
...
### Comparing `Slame-1.5.7.2/README.md` & `Slame-1.5.7.3/README.md`

 * *Files identical despite different names*

### Comparing `Slame-1.5.7.2/Slame/slame.py` & `Slame-1.5.7.3/Slame/slame.py`
...
### Comparing `Slame-1.5.7.2/Slame.egg-info/PKG-INFO` & `Slame-1.5.7.3/Slame.egg-info/PKG-INFO`
...
### Comparing `Slame-1.5.7.2/setup.py` & `Slame-1.5.7.3/setup.py`
